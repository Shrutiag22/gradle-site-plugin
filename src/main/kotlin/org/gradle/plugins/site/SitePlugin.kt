...
open class SitePlugin : Plugin<Project> {
    ...
    private fun deriveProjectDescription(project: Project): ProjectDescriptor {
        val projectDescriptor = ProjectDescriptor(project.name, project.group.toString(), project.description!!, project.version.toString(), EnvironmentDescriptor(project.gradle.gradleVersion))
